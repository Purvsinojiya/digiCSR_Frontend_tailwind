...
function singup() {
  return (
    <div className="h-screen w-screen flex relative justify-center align-center">
      ...
      <div
        className=" h-4/6 w-80 sm:h-4/6 sm:w-80 md:w-80 md:h-4/6 xl:h-3/5 lg:h-4/6 lg:w-80 xl:w-96 2xl:w-96 flex absolute mt-32 flex-col overflow-hidden rounded-sm xl:mt-40 2xl:mt-40 "
        id="mainbg"
      >
        <div className="h-14 w-full  flex">
          <div className=" w-2/4 h-full" id="background">
            <div
  ...
  <input type="text" class="w-6 h-6 text-center text-2xl border border-gray-300 rounded focus:outline-none focus:border-blue-500" maxlength="1" />
          ...
          <div className="flex flex-col justify-center items-center mt-4 xl:mt-6 2xl:mt-6  ">
